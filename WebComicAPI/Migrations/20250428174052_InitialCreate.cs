    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BannerHighlights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BannerHighlights_Mangas_MangaId",
                        column: x => x.MangaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyLists", x => new { x.UserId, x.MangaId });
                    table.ForeignKey(
                        name: "FK_MyLists_Mangas_MangaId",
                        column: x => x.MangaId,
                        principalTable: "Mangas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BannerHighlights_MangaId",
                table: "BannerHighlights",
                column: "MangaId");
